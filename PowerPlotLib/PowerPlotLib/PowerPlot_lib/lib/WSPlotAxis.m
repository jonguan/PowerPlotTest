...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _axisColor = [[UIColor blackColor] retain];
...
- (void)dealloc {
    ...
    [_axisColor release];
    [_gridColor release];
    for (UILabel *aLabel in _tickUILabelsX) {
        [aLabel removeFromSuperview];
    }
    for (UILabel *aLabel in _tickUILabelsY) {
        [aLabel removeFromSuperview];
    }
    [_axisUILabelX removeFromSuperview];
    [_axisUILabelY removeFromSuperview];
    [_tickUILabelsX release];
    [_tickUILabelsY release];
    [_axisUILabelX release];
    [_axisUILabelY release];
    _axisX = nil;
    _axisY = nil;
    _ticksX = nil;
    _ticksY = nil;
